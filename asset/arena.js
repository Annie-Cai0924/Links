...
// 	let channelBlocks = document.querySelector('#channel-blocks')
  ...
  // Request the Are.na API to get channel data
  fetch(`https://api.are.na/v2/channels/${channelSlug}?per=100`, { cache: 'no-store' })

  // Parse the JSON data and classify it
  ...
  // Iterate through categories and render HTML
 ...
 // Generate HTML code according to different types
